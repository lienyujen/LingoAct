...
- **Two language axes on the session**, because a class in Taiwan varies them
  ...
  The teacher sets both when creating the session and can change them in
  教師端設定; a student with no preference of their own opens in the teacher's
  導引語, and a student who has chosen keeps their choice.
