...
const messages = {
  'zh-TW': {
    ...
    readingTitle: '閱讀', readingGrammarOn: '語法標注：開', readingGrammarOff: '語法標注：關',
    close: '關閉',
    answerSent: '答案已送出。',
  ...
  en: {
    ...
    readingTitle: 'Reading', readingGrammarOn: 'Grammar notes on', readingGrammarOff: 'Grammar notes off',
    close: 'Close',
